...
static ngx_inline void ngx_http_v2_queue_frame(ngx_http_v2_connection_t *h2c,
                                               ngx_http_v2_out_frame_t *frame) {
...
#define ngx_http_v2_write_uint32(p, s)                                         \
  ((p)[0] = (u_char)((s) >> 24), (p)[1] = (u_char)((s) >> 16),                 \
   (p)[2] = (u_char)((s) >> 8), (p)[3] = (u_char)(s), (p) + sizeof(uint32_t))
