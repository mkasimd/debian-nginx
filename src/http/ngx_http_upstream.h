...
#define NGX_HTTP_UPSTREAM_FT_STATUS                                            \
  (NGX_HTTP_UPSTREAM_FT_HTTP_500 | NGX_HTTP_UPSTREAM_FT_HTTP_502 |             \
   NGX_HTTP_UPSTREAM_FT_HTTP_503 | NGX_HTTP_UPSTREAM_FT_HTTP_504 |             \
   NGX_HTTP_UPSTREAM_FT_HTTP_403 | NGX_HTTP_UPSTREAM_FT_HTTP_404 |             \
...
struct ngx_http_upstream_s {
  ...
  ngx_int_t (*rewrite_redirect)(ngx_http_request_t *r, ngx_table_elt_t *h,
                                size_t prefix);
