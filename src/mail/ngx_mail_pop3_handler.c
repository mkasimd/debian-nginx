...
static ngx_int_t ngx_mail_pop3_user(ngx_mail_session_t *s,
                                    ngx_connection_t *c) {
  ngx_str_t *arg;
  ...
  ngx_log_debug1(NGX_LOG_DEBUG_MAIL, c->log, 0, "pop3 login: \"%V\"",
                 &s->login);
...
static ngx_int_t ngx_mail_pop3_pass(ngx_mail_session_t *s,
                                    ngx_connection_t *c) {
  ngx_str_t *arg;
  ...
  ngx_log_debug1(NGX_LOG_DEBUG_MAIL, c->log, 0, "pop3 passwd: \"%V\"",
                 &s->passwd);
#endif
...
static ngx_int_t ngx_mail_pop3_stls(ngx_mail_session_t *s,
                                    ngx_connection_t *c) {
#if (NGX_MAIL_SSL)
  ngx_mail_ssl_conf_t *sslcf;
...
static ngx_int_t ngx_mail_pop3_apop(ngx_mail_session_t *s,
                                    ngx_connection_t *c) {
  ngx_str_t *arg;
  ngx_mail_pop3_srv_conf_t *pscf;
  ...
  ngx_log_debug2(NGX_LOG_DEBUG_MAIL, c->log, 0, "pop3 apop: \"%V\" \"%V\"",
                 &s->login, &s->passwd);
...
static ngx_int_t ngx_mail_pop3_auth(ngx_mail_session_t *s,
                                    ngx_connection_t *c) {
  ngx_int_t rc;
  ngx_mail_pop3_srv_conf_t *pscf;
